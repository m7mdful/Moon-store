...
<template>
  <div class="container mt-5 px-2 px-md-4">
    ...
    <!-- Title -->
    <h4 class="fw-bold mt-5 mb-4 ps-2">Wishlist ({{ products.length }} items)</h4>
    ...
    <section class=" mb-5">
      <div v-if="products.length > 0" class="row gy-5 justify-content-center">
          ...
          <!-- Delete Icon -->
          <button class="btn position-absolute top-0 end-0 z-3 m-3 p-1 gx-3 border-0" style="width: 30px; height: 30px" @click="showDeleteModal(product.id)">
      ...
      <CartEmpt v-else msg="Your Wishlist is empty" smdet="Start exploring and add items you love!"/>
    </section>

     <!-- Bottom Buttons -->
    <div class="d-flex justify-content-center gap-3 mb-5 flex-wrap">
        <button class="btn btn-dark px-4 py-2 fs-4" style="width: 300px; height: 50px" @click="showCartModal">Add All to Cart</button>

        <button style="width: 300px; height: 50px" class="btn btn-outline-danger d-flex align-items-center justify-content-center gap-2 px-4 py-2" @click="showClearAllModal">
   ...
   <!-- Confirmation Modal -->
    <div class="modal fade"
      id="confirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" aria-hidden="true" ref="confirmModalEl">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center fs-5">
            ...
            <button type="button" class="btn btn-danger fs-6" @click="confirmAction">Yes, Confirm</button>
          </div>
        </div>
  </div>
</div>
...
<!-- Add to Cart Modal -->
<div class="modal fade" id="cartModal" tabindex="-1" aria-labelledby="cartModalLabel" aria-hidden="true" ref="cartModalEl">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fs-4" id="cartModalLabel">Items Added to Cart</h5>
      </div>
      <div class="modal-body d-flex justify-content-center fs-5">
