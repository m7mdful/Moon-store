...
<template>
  <div class="container">
    ...
    >
      <div class="d-flex flex-column gap-5">
        <div class="d-flex ms-2 justify-content-center">
          <img class="imagscaling" src="../assets/img/shop9.png" alt="" />
        </div>
        <div class="d-flex flex-row gap-2 justify-content-center">
          <button class="bg-transparent border-0">
            <img src="../assets/img/shop5.png" width="60" alt="" />
          </button>
          <button class="bg-transparent border-0">
            <img src="../assets/img/shop5.png" width="60" alt="" />
          </button>
      ...
      <div class="d-flex flex-column text-center text-lg-start">
        ...
        <div class="d-flex gap-2">
          <div class="d-flex gap-2 mb-3">
            ...
            ></span>
            <span
              class="border-black bg-secondary"
              style="width: 40px; height: 40px"
            ></span>
            <span
              class="border-black bg-primary"
              style="width: 40px; height: 40px"
            ></span>
            <span
              class="border-black bg-danger"
              style="width: 40px; height: 40px"
            ></span>
            <span
              class="border-black bg-success mb-5"
              style="width: 40px; height: 40px"
            ></span>
          </div>
        </div>
        <div class="d-flex flex-column gap-3">
          <div class="d-flex flex-row gap-2 w-100">
            <div
              ...
              style="width: 130px; height: 48; border: 1px; border-style: solid"
            >
    ...
    <div class="d-flex flex-column gap-2" style="margin: 60px 0px">
      ...
      <div class="d-flex flex-wrap align-content-center" style="gap: 30px">
        <productCard
          :imgSrc="shop9"
