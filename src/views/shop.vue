...
<template>
  <div class="container mt-5 px-2 px-md-4">
    ...
    <nav
      ...
      class="d-flex align-items-center justify-content-between ms-1"
    >
    ...
    <div
      class="d-flex flex-row justify-content-between align-items-center d-lg-none mt-4"
    >
      ...
      <div class="d-lg-none d-block">
        <div class="dropdown">
          <button
            class="btn btn-sm dropdown-toggle border-0 fs-6"
            type="button"
    ...
    >
      ...
      <div class="offcanvas-body">
        ...
        >
          ...
          />
          <label class="form-check-label" :for="'desktop-' + cat.id">{{
            cat.name
          }}</label>
        </div>
        <hr />
        ...
        >
          ...
          />
          <label class="form-check-label" :for="'desktop-' + price.id">{{
            price.label
          }}</label>
        </div>
        <hr />
        ...
        >
          ...
          />
          <label class="form-check-label" :for="'desktop-tag-' + cat.id">{{
            cat.name
          }}</label>
        </div>
      </div>
      ...
      <div class="d-flex gap-3 mb-4 mt-4 text-center mt-5">
        <button
          type="button"
          class="log-btn d-flex justify-content-center align-items-center gap-2 mb-3 text-white w-50"
          style="
            height: 40px;
            font-size: 18px;
            padding: 10px;
    ...
    <div class="d-flex flex-row justify-content-between mt-5">
      <p class="fs-4 fw-semibold mb-5 ms-3">
        Showing {{ filteredProducts.length }} items
      </p>
